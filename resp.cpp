...
RespValue RespValue::makeBulkString(const std::string& msg) {
    RespValue simpleString;
    simpleString.respType = RespType::BULK_STRING;
    std::optional<std::string> value = msg;
    simpleString.value = value;
    return simpleString;
}
